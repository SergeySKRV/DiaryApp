...
enum L10n {
    ...
    static let detailsAddPhoto = NSLocalizedString("details.add.photo", comment: "Add photo button")
    static let detailsChangePhoto = NSLocalizedString("details.change.photo", comment: "Change photo button")
    ...
    static let accessibilityEntryLabelFormat = NSLocalizedString("accessibility.entry.label.format", comment: "VoiceOver label for diary entry with arguments")
    static let accessibilityWithPhoto = NSLocalizedString("accessibility.with.photo", comment: "VoiceOver state with photo")
    static let accessibilityWithoutPhoto = NSLocalizedString("accessibility.without.photo", comment: "VoiceOver state without photo")
}
